        ...
        <div className='proyectos'>
            ...
            <div className='container'>
                ...
                <Card style={{ height: '36vh', }}>
                    <div style={{ height: '122%' }} className='single-content'>
                        <Card.Img style={{ height: '42vh' }} variant="top" src={Burger} />
                        <Card.Body className='text-content'>
                            <Card.Text style={{ width: '112%' }}>
                ...
                <Card >
                    <div className='single-content' style={{ height: '42vh' }}>
                        <Card.Img variant="top" src={Hootie} />
                        <Card.Body className='text-content'>
                            <Card.Text style={{ width: '112%' }}>
                                Ganemosle al virus es una plataforma web desarrollada para la empresa Hootie Hoo con el objetivo de informar y enseñar a niños y adultos de manera didactica sobre el covid-19, utilizando técnicas de gamificación con diversos juegos, videos y modulos intormativos.
                    </Card.Text>
                            <Row>
                ...
                <Card >
                    <div className='single-content'>
                        ...
                        <Card.Body className='text-content'>
                            <Card.Text style={{ width: '112%' }}>
                                Markdown Links es una librería de Node.js que nos permite buscar en un directorio todos los archivos en formato Markdown (.md) que en su interior contengan link. Esta libreria nos permite poder validar el estado actual de cada link contenido, entregando un total de link rotos y su ubicación.
                    </Card.Text>
                            <Row>
